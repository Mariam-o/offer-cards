...
class AdsAdapter(private val offers: List<Offer>) : RecyclerView.Adapter<AdsAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val vendorButton: Button = itemView.findViewById(R.id.vendorButton)
    }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.priceButton.text = if (offer.priceAfter != null) "${offer.priceAfter} ${offer.currency}" else "N/A"
